...
(function(a,d){var m=function(a){var d=a.target||".time",e=a.lang||{second:"\u79d2",minute:"\u5206\u949f",hour:"\u5c0f\u65f6",day:"\u5929",month:"\u4e2a\u6708",year:"\u5e74",ago:"\u524d",error:"NaN"};addEventListener("DOMContentLoaded",function(){for(var a=$jscomp.makeIterator(document.querySelectorAll(d)),c=a.next();!c.done;c=a.next()){c=c.value;var b=c.dateTime;var f=c.title,g=c.innerHTML;if(!b||isNaN(new Date(b=b.replace(/(.*)[a-z](.*)\+(.*)/gi,"$1 $2").replace(/-/g,"/"))))if(f&&!isNaN(new Date(f=
